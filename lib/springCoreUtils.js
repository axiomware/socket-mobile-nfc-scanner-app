...
class SpringCoreUtils {
  ...
  /* helper functions */
    _isWayHost (pcb) { return (pcb & 0x80) ? 1 : 0 }
    _isChannelInterrupt (pcb) { return (pcb & 0x40) ? 1 : 0 }
    _isSecure (pcb) { return (pcb & 0x20) ? 1 : 0 }
    _isHeaderLong (pcb) { return (pcb & 0x10) ? 1 : 0 }
    _getSequence (pcb) { return pcb & 0x0f }    
